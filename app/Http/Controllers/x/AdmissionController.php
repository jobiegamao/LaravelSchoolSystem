...
class AdmissionController extends AppBaseController
{
    ...
    public function index()
    {
        ...
        return view('menu_Admin.view_admissionList.index', [
            'person' => $admissions
        ]);      
    }
    ...
    {
        return view('menu_Admin.view_admissionList.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('menu_Admin.view_admissionList.show')->with('person', $admission);
    }

    public function edit($id)
    {
        $admission = Admission::find($id); //get id
        return view('menu_Admin.view_admissionList.edit')->with('person', $admission); // syntax:: (viewfoldername.filename)->with(newVarName, IDvar)
    }
    ...
    public function destroy($id)
    {
        ...
        public function acceptedList(){
            ...
            //dd($admissions);
            return view('menu_Admin.view_admissionList.acceptedList', [
                'person' => $admissions
            ]);  
        }
