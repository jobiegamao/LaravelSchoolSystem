...
class StudentsController extends AppBaseController
{
    ...
    public function enrollID($id)
    {
       ...
       //course_1 should be filled validator
       $registration = \App\Models\RegisterAdmission::find($id);
       
  
        if (Students::where('register_admission_id',$id)->exists() || $registration->course_1 == null) {
            //student is already enrolled or 1 course must be needed
