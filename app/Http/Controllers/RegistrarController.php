...
class RegistrarController extends Controller
{
    ...
    public function goTo_enrollmentList()
    {
        ...
        //dd($students);
        return view('menu_Registrar/enrollment/index',[
            'students' => $students
        ]);
    ...
    public function studentShow($id) //not yet routed/ not done
    {
        ...
        return view('menu_Registrar/enrollment/show')
    ...
    public function enrollProgrammeEdit($id){
        $student = Student::find($id);
        return view('menu_Registrar.enrollment.enrollProgramme.edit', [
            'student' => $student
        ]);
    }
   ...
   /**
    ...
    {
        $student = Student::find($id);
        return view('menu_Registrar/enrollment/enrollProgramme/enrollProgramme')
...
// echo($prereg);
 //dd($prereg);
        ...
        //dd($student);
        return view('menu_Registrar/addCourses/prereg', [
            'person' => $person,
            'student' => $student,
            'prereg' => $prereg
    ...
    public function goTo_classOfferings(Request $request){
        ...
        return view('menu_Registrar/addCourses/classOfferings', [
            'student' =>  $student,
            'classes' => $classes,
            'course' => $course,
            'certOptions' => $certOptions
    ...
    public function classOfferingsShow(Request $request){
        $c = ClassOffering::all();
        return view('menu_Registrar.classes.classOfferings',[
            'classes' => $c
        ]);
    }
}
